...
//#region node_modules/.nitro/vite/services/ssr/assets/theme-provider-BAKfitBF.js
...
function ThemeProvider({ children, defaultTheme = "system", storageKey = "careerforge-theme", ...props }) {
